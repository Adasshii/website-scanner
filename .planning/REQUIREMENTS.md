...
- [x] **CMP-13**: A scheduled retention job expires prospect, scan, and outreach data (placeholder: 12 months from last contact, pending the LIA — not a legal fact)
...
- [x] **TRK-01**: Every prospect carries a lifecycle state (new, qualified, contacted, replied, booked)
