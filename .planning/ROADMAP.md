...
- [ ] 02-01-PLAN.md — suppressions table (migration 014) + lib/suppression.ts (isSuppressed/writeSuppression/liftSuppression) + unit & integration suites (wave 1)
...
| 2. Compliance Spine | 0/7 | Not started | - |
